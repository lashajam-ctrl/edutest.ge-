...
ჩვეულებრივ Variable ტიპით დაამატეთ `RESULT_EMAIL_FROM`, მაგალითად: `EduTest.ge <results@edutest.ge>`. შედეგებისა და ელფოსტის დადასტურების წერილებისთვის ჯერ Resend-ში უნდა დადასტურდეს `edutest.ge` (SPF და DKIM ჩანაწერები). ბავშვის მიერ მითითებულ მშობლის მისამართზე შედეგი არ იგზავნება, სანამ მშობელი დადასტურების ბმულს არ გახსნის.
