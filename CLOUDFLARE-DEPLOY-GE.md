...
Google/Microsoft შესვლა ჩაირთვება მხოლოდ OAuth მონაცემების მიღების შემდეგ. Worker-ის **Settings → Variables and Secrets** განყოფილებაში Secret ტიპით უნდა დაემატოს:
