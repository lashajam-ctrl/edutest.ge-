...
const I18N={
  ka:{
    ...
    exit_test_confirm:'ნამდვილად გასვლა? პროგრესი წაიშლება.',
  ...
  en:{
    ...
    exit_test_confirm:'Exit test? Your progress will be lost.',
    back_to_tests:'← Tests',
  ...
  ru:{
    ...
    exit_test_confirm:'Выйти из теста? Прогресс будет потерян.',
    back_to_tests:'← Тесты',
